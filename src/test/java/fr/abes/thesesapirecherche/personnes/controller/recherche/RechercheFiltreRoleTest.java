...
public class RechercheFiltreRoleTest extends PersonneControllerTest {
    ...
    public void rechercherRoleDirecteur() throws Exception {
        mockMvc.perform(get("/api/v1/tests/personnes/recherche/?q=rousseau&index=per_recherche_simple_rousseau&filtres=[role=\"directeur de thèse\"]"))
                ...
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s353038')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s303558')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s303565')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s261078')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s236755')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s236749')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s236757')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s236736')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s216908')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s216921')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s216950')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s192553')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s192600')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s192592')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s170202')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s170210')])]").exists())
                .andExpect(jsonPath("$[?(@.theses[?(@.nnt=='s127632')])]").exists())
