...
public class PersonneControllerTest extends ThesesApiRechercheApplicationTests {
    ...
    public void rechercherAvecId() throws Exception {
        mockMvc.perform(get("/api/v1/tests/personnes/personne/050646176/?index=per_recherche_simple_rousseau"))
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='1997PA040286')].roles[?(@=='auteur')]").exists())
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].roles[?(@=='directeur de thèse')]").exists())
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].roles[?(@=='membre du jury')]").exists())
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].roles[?(@=='président du jury')]").exists())
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].roles[?(@=='rapporteur')]").exists())
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2019LYSE2095')].roles[?(@=='rapporteur')]").exists())
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2017PA01H038')].roles[?(@=='membre du jury')]").exists())
