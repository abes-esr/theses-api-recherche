...
public class PersonneControllerTest extends ThesesApiRechercheApplicationTests {
    ...
    public void rechercherAvecId() throws Exception {
        mockMvc.perform(get("/api/v1/tests/personnes/personne/050646176/?index=per_recherche_simple_rousseau"))
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].role").value("directeur de thèse"))
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].date_soutenance").value("01/12/2020"))
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].role").value("président du jury"))
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].date_soutenance").value("17/04/2021"))
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2019LYSE2095')].date_soutenance").value("15/11/2019"))
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2017PA01H038')].date_soutenance").value("14/11/2017"))
