...
public class PersonneControllerTest extends ThesesApiRechercheApplicationTests {
    ...
    public void rechercherAvecId() throws Exception {
        mockMvc.perform(get("/api/v1/tests/personnes/personne/050646176/?index=per_recherche_simple_rousseau"))
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].status", Matchers.containsInRelativeOrder("soutenue","soutenue")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].titre", Matchers.containsInRelativeOrder("La mode à l'épreuve de l'art : une historiographie des discours sur la mode en France : 1800-1930","La mode à l'épreuve de l'art : une historiographie des discours sur la mode en France : 1800-1930")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].etablissement_soutenance.nom",Matchers.containsInRelativeOrder("Paris 1","Paris 1")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].discipline",Matchers.containsInRelativeOrder("Histoire de l'art","Histoire de l'art")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].date_soutenance",Matchers.containsInRelativeOrder("2020-12-01","2020-12-01")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].auteurs[?(@.id=='221682724')]").exists())
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].auteurs[?(@.id=='221682724')].nom", Matchers.containsInRelativeOrder("Hammen","Hammen")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].auteurs[?(@.id=='221682724')].prenom", Matchers.containsInRelativeOrder("Emilie","Emilie")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].auteurs[?(@.id=='221682724')].has_idref", Matchers.containsInRelativeOrder(true,true)))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].directeurs[?(@.id=='050646176')]").exists())
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].directeurs[?(@.id=='050646176')].nom", Matchers.containsInRelativeOrder("Rousseau","Rousseau")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].directeurs[?(@.id=='050646176')].prenom", Matchers.containsInRelativeOrder("Pascal","Pascal")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2020PA01H073')].directeurs[?(@.id=='050646176')].has_idref", Matchers.containsInRelativeOrder(true,true)))
                 /***** Thèse n°2021SORUL154 *****/
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')]").exists())
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].role", Matchers.containsInRelativeOrder("rapporteur","président du jury")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].status", Matchers.containsInRelativeOrder("soutenue","soutenue")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].titre", Matchers.containsInRelativeOrder("Les artistes musicalistes : théories et pratiques d'une union des arts (1932-1960)","Les artistes musicalistes : théories et pratiques d'une union des arts (1932-1960)")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].etablissement_soutenance.nom", Matchers.containsInRelativeOrder("Sorbonne université","Sorbonne université")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].discipline", Matchers.containsInRelativeOrder("Histoire de l'art","Histoire de l'art")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].date_soutenance", Matchers.containsInRelativeOrder("2021-04-17","2021-04-17")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].auteurs[?(@.id=='199688613')]").exists())
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].auteurs[?(@.id=='199688613')].nom", Matchers.containsInRelativeOrder("Sergent","Sergent")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].auteurs[?(@.id=='199688613')].prenom", Matchers.containsInRelativeOrder("Marion","Marion")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].auteurs[?(@.id=='199688613')].has_idref", Matchers.containsInRelativeOrder(true,true)))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].directeurs[?(@.id=='033730342')]").exists())
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].directeurs[?(@.id=='033730342')].nom", Matchers.containsInRelativeOrder("Pierre","Pierre")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].directeurs[?(@.id=='033730342')].prenom", Matchers.containsInRelativeOrder("Arnauld","Arnauld")))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2021SORUL154')].directeurs[?(@.id=='033730342')].has_idref", Matchers.containsInRelativeOrder(true,true)))
                 /***** Thèse n°2019LYSE2095 *****/
                .andExpect(jsonPath("$.theses[?(@.nnt=='2019LYSE2095')]").exists())
                .andExpect(jsonPath("$.theses[?(@.nnt=='2019LYSE2095')].role").value("rapporteur"))
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2017PA01H038')].role").value("membre du jury"))
                ...
                .andExpect(jsonPath("$.theses[?(@.nnt=='2017PA01H038')].auteurs[?(@.id=='180858416')].nom").value("Conésa"))
                .andExpect(jsonPath("$.theses[?(@.nnt=='2017PA01H038')].auteurs[?(@.id=='180858416')].prenom").value("Héloïse"))
